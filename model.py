...
class captcha_model():
    def __init__(self, model_path,useCircleLabel=1):
        self.model_path = model_path
        self.useCircle = useCircleLabel
    def load_model(self, loss='categorical_crossentropy', optimizer='Adamax', metrics=['accuracy']):
